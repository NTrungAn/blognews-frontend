...
const strengthColor = ['', 'bg-[#ba1a1a]', 'bg-yellow-500', 'bg-green-600'];

const EDITORIAL_ITEMS = [
  { icon: 'person_add', text: 'Tạo tài khoản miễn phí trong vài phút' },
  { icon: 'bookmark', text: 'Lưu bài viết và đọc lại mọi lúc' },
  { icon: 'forum', text: 'Bình luận, theo dõi tác giả và nhận tin nóng' },
];
...
function RegisterPage() {
  ...
  const validate = (): boolean => {
    ...
    if (form.username.trim() === '') {
      ...
      newErrors.username = 'Chỉ cho phép chữ thường, số và dấu gạch dưới';
    }
  ...
  const inputCls = (field: keyof FieldErrors) =>
    `w-full border-0 border-b-2 bg-white px-0 py-2.5 text-sm text-[#191c1d] placeholder:text-[#727785] transition-colors focus:outline-none ${
      errors[field]
        ? 'border-[#ba1a1a] focus:border-[#ba1a1a]'
        : 'border-[#0058be]/30 focus:border-[#0058be]'
    }`;
  ...
  const editorialBlock = (
    <>
      ...
      <h2 className="news-serif mt-6 border-b-2 border-[#0058be] pb-4 text-3xl font-bold leading-snug text-[#191c1d] xl:text-4xl">
        Gia nhập cộng đồng độc giả NewsFlow
      </h2>
      <p className="mt-4 text-sm leading-relaxed text-[#727785]">
        Đăng ký miễn phí để lưu bài viết yêu thích, bình luận, theo dõi tác giả và nhận thông báo
        tin nóng — dành riêng cho độc giả muốn gắn bó lâu dài với tòa soạn số.
      </p>
      <ul className="mt-8 space-y-3 border-t border-[#0058be]/30 pt-8">
        {EDITORIAL_ITEMS.map((item) => (
          <li
            key={item.icon}
            className="flex items-start gap-3 border-b border-[#0058be]/20 pb-3 text-sm text-[#424754] last:border-b-0 last:pb-0"
          >
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="mx-auto flex w-full max-w-6xl flex-1 flex-col lg:flex-row">
        ...
        <aside className="relative hidden flex-col justify-between overflow-hidden border-r border-[#0058be]/20 bg-white text-[#191c1d] lg:flex lg:w-[44%]">
          <div className="relative z-10 p-10 xl:p-12">{editorialBlock}</div>
          ...
          <blockquote className="relative z-10 border-t-2 border-[#0058be]/30 bg-white px-10 py-6 xl:px-12">
            <p className="news-serif text-base italic leading-relaxed text-[#424754]">
              &ldquo;Một tài khoản — Toàn bộ trải nghiệm đọc báo cá nhân hóa&rdquo;
            </p>
          ...
          <div className="mx-auto w-full max-w-md">
            ...
            <div className="mb-8 border-b-2 border-[#0058be] pb-6 lg:hidden">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[#727785]">
                Đăng ký miễn phí để lưu bài viết, bình luận và nhận thông báo tin nóng.
              </p>
            </div>
            ...
            <div className="mb-8 border-b-2 border-[#0058be] pb-4">
              ...
              <h2 className="news-serif mt-1 text-2xl font-bold text-neutral-950">Tạo tài khoản mới</h2>
              <p className="mt-2 text-sm text-neutral-500">
                Điền thông tin bên dưới để bắt đầu đọc và tương tác trên NewsFlow.
              </p>
            </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5" noValidate>
                <div>
                  <div className="mb-1.5 flex items-center gap-2">
                    ...
                    <span className="border border-[#0058be]/30 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#727785]">
                      Tùy chọn
                    </span>
                  </div>
                  <input
                ...
                <div>
                  ...
                  >
                    Tên người dùng <span className="text-[#ba1a1a]">*</span>
                  </label>
                  <input
                    id="username"
                    type="text"
                  ...
                  />
                  {errors.username && (
                    <p className="mt-1 flex items-center gap-1 text-xs text-[#ba1a1a]">
                ...
                <div>
                  ...
                  {form.password.length > 0 && (
                    <div className="mt-2 border-t border-[#0058be]/20 pt-2">
                      <div className="flex gap-1">
                        {[1, 2, 3].map((level) => (
                          <div
                            key={level}
                            className={`h-1 flex-1 transition-all ${
                              strength >= level ? strengthColor[strength] : 'bg-[#0058be]/15'
                            }`}
                          />
                        ))}
                      </div>
                      <p className="mt-1 text-xs text-[#727785]">
                        Độ mạnh: <span className="font-semibold">{strengthLabel[strength]}</span>
                      </p>
                    </div>
                  )}
                ...
                <div>
                  <label className="flex cursor-pointer items-start gap-3">
                    <input
                      ...
                      className="mt-0.5 h-4 w-4 border-[#0058be]/40 accent-[#0058be]"
                    />
                    <span className="text-sm text-[#424754]">
                      Tôi đồng ý với{' '}
                      <a
                        href="#"
                        className="font-semibold text-[#0058be] underline decoration-[#0058be]/40 underline-offset-2 hover:decoration-[#0058be]"
                      >
                        Điều khoản sử dụng
                      </a>{' '}
                      và{' '}
